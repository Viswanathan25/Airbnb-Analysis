...
viswa = pymongo.MongoClient('Your ID')
db = viswa['sample_airbnb']
...
st.set_page_config(page_title="Airbnb Data Visualization | By Viswanathan",layout="wide")
